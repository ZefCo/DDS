...
public:
    ...
    std::array<double, total_measures> sweep() {
        ...
        double Nplus = 0, current, exchanges;
        ...
        measurements = {current, exchanges, Nplus};
