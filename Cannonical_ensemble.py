...
def main():
    ...
    sizes, temps, sfk10, sfk01, zen10, zen01, sqr01, sqr10, rad01, rad10, bc01, bc10 = [], [], [], [], [], [], [], [], [], [], [], []
    ...
    for row in range(rows):
        ...
        prefactor = (numpy.sin(numpy.pi / orthogonal) * (2*parralel)**-1)**2
        ...
        for s in seed:
            ...
            # print(ensemble)
            ensemble["SFk01"] = prefactor * ensemble["SFk01"]
            ensemble["SFk10"] = prefactor * ensemble["SFk10"]
        ...
        bc10_local = (4/3) * (1 - (sqr10_local / (2*sfk10_local**2)))
        bc01_local = (4/3) * (1 - (sqr01_local / (2*sfk01_local**2)))
        ...
        bc10.append(bc10_local), bc01.append(bc01_local)

        # master = pandas.concat([master, pandas.Series()])

    master = pandas.DataFrame(data={"Size": sizes, "Temp": temps,
                                    "Rad10": rad10, "SFk10": sfk10, "Sqr10": sqr10, "Zen10": zen10, "BC10": bc10,  
                                    "Rad01": rad01, "SFk01": sfk01, "Sqr01": sqr01, "Zen01": zen01, "BC01": bc01})
